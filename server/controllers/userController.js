...
module.exports.getOtherConfessionGroups = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({
        message: "Error geting confession groups",
        error: error.message,
      });
  }
};
...
module.exports.getConfessionGroup = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Error geting confession group", error: error.message });
  }
};
...
module.exports.joinGroup = async (req, res) => {
  try {
    ...
    await User.findByIdAndUpdate(userId, {
      $addToSet: { confessionGroups: confessionGroup._id },
    });
    ...
    res
      .status(500)
      .json({
        message: "Error joining confession group",
        error: error.message,
      });
  }
};
...
module.exports.deleteConfession = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Error deleting confession", error: error.message });
  }
};
